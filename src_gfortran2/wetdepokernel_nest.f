      subroutine wetdepokernel_nest(nunc,deposit,x,y,nage)
C                                    i      i    i i  i
********************************************************************************
*                                                                              *
...
***********************************************
     ...
     +(jy.le.numygridn-1)) then
        w=wx*wy
        do 22 k=1,nspec
22        wetgriduncn(ix,jy,k,nunc,nage)=
     +    wetgriduncn(ix,jy,k,nunc,nage)+deposit(k)*w
      endif
     ...
     +(jyp.le.numygridn-1)) then
        w=(1.-wx)*(1.-wy)
        do 23 k=1,nspec
23        wetgriduncn(ixp,jyp,k,nunc,nage)=
     +    wetgriduncn(ixp,jyp,k,nunc,nage)+deposit(k)*w
      endif
     ...
     +(jy.le.numygridn-1)) then
        w=(1.-wx)*wy
        do 24 k=1,nspec
24        wetgriduncn(ixp,jy,k,nunc,nage)=
     +    wetgriduncn(ixp,jy,k,nunc,nage)+deposit(k)*w
      endif
     ...
     +(jyp.le.numygridn-1)) then
        w=wx*(1.-wy)
        do 25 k=1,nspec
25        wetgriduncn(ix,jyp,k,nunc,nage)=
     +    wetgriduncn(ix,jyp,k,nunc,nage)+deposit(k)*w
      endif
