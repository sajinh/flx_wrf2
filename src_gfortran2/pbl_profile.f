      subroutine pbl_profile(ps,td2m,zml1,t2m,tml1,u10m,uml1,stress,
     &                       hf)
*********************************************************************
*                                                                   *
*                    G. WOTAWA, 1995-07-07                          *
...
*********************************************************************
      ...
      if(deltau.le.0.) then    !! Monin-Obukhov Theory not
     ...
     &            (log(zml1/2.)-psih(zml1,al)+psih(2.,al))
      ...
      do 20 iter=1,maxiter
        alold=al
        ustar=(kappa*deltau)/
     &        (log(zml1/10.)-psim(zml1,al)+psim(10.,al))
        thetastar=(kappa*deltat/r1)/
     &            (log(zml1/2.)-psih(zml1,al)+psih(2.,al))
        al=(tmean*ustar**2)/(ga*kappa*thetastar)
